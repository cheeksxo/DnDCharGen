  ...
  public partial class Startup
  {
    ...
    public void ConfigureServices(IServiceCollection services)
    {
      ...
      services.AddMvc(options =>
      {
          ...
          options.OutputFormatters.Add(new DnDCharGen.Data.CsvDataContractSerializerOutputFormatter());
          options.OutputFormatters.Add(new DnDCharGen.Data.XlsDataContractSerializerOutputFormatter());
      });
      ...
      services.AddDbContext<DnDCharGen.Data.AzureDatabaseContext>(options =>
      {
...
#pragma warning restore 0168
      ...
      app.UseMvc(builder =>
      {
          ...
          oDataBuilder.EntitySet<DnDCharGen.Models.AzureDatabase.Race>("Races");

          this.OnConfigureOData(oDataBuilder);

          var model = oDataBuilder.GetEdmModel();

          builder.MapODataServiceRoute("odata/AzureDatabase", "odata/AzureDatabase", model);
